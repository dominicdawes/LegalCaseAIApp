# agents/quiz/worker_config.py
"""
Worker-class abstraction for quiz-agent nodes.

WorkerClass tiers:
  "tool_only"   — no LLM; deterministic logic or pure DB writes
  "worker_low"  — cheapest model; routing, grounding claim extraction, critic
  "worker_mid"  — mid-range; planning, blueprint, concept synthesis, evaluation
  "orchestrator"— flagship; question drafting, distractor generation, revision

Override provider with env var QUIZ_AGENT_PROVIDER (default: anthropic).
"""
...
DEFAULT_PROVIDER: str = os.getenv("QUIZ_AGENT_PROVIDER", "deepseek")
